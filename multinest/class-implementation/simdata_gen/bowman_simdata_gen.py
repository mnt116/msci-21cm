...
sim_width = 8.1 # width
sim_tau = 6.88 # optical depth
int_time = 1.6e8 # antennna integration time  
theta = [a0,a1,a2,a3,a4,sim_amp,sim_x0,sim_width,sim_tau]

mockmodel = md.bowman(freq) # this is the user defined model, see model_database.py for more models
...
np.savetxt("sim_signal_bowman.txt", data, delimiter=",") # save data in a .txt file; this mimics the procedure when actual data is imported e.g. EDGES
...
plt.xlabel("Frequency/MHz")
plt.savefig("mockdata_bowman.png")
